...
/* harmony export */ });
const eventLocation = () => ['Moscow', 'St. Petersburg', 'London', 'New-York', 'Dubai', 'Larnaka', 'Ontario'];
...
const createAddEventItemTemplate = tripEvent => {
  ...
  const createEventTypes = (types = (0,_mock_event_type__WEBPACK_IMPORTED_MODULE_2__.eventTypes)(), chosenEventType) => {
  ...
  const eventTypesElements = createEventTypes((0,_mock_event_type__WEBPACK_IMPORTED_MODULE_2__.eventTypes)(), eventType);
...
const createTripEventsItemTemplate = tripEvent => {
  ...
  return `<li class="trip-events__item">
	...
	@@ -36,5 +73,5 @@ export const createTripEventsItemTemplate = () => (
                  <span class="visually-hidden">Open event</span>
                </button>
              </div>
            </li>`;
...
/* harmony import */ var _mock_events__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mock/events */ "./src/mock/events.js");
...
const tripEvents = Array.from({
  length: Trip_Count
}, _mock_events__WEBPACK_IMPORTED_MODULE_8__.generateTripEvent);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderTemplate)(TripControlsNavigationElement, (0,_view_site_menu_view_js__WEBPACK_IMPORTED_MODULE_1__.createTripTabsTemplate)(), _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderTemplate)(TripControlsFiltersElement, (0,_view_trip_filter_view_js__WEBPACK_IMPORTED_MODULE_2__.createTripFiltersTemplate)(), _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderTemplate)(TripEventsListElement, (0,_view_trip_events_edit_form__WEBPACK_IMPORTED_MODULE_5__.createEditedEventItemTemplate)(tripEvents[1]), _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderTemplate)(TripEventsListElement, (0,_view_add_new_event_form_js__WEBPACK_IMPORTED_MODULE_4__.createAddEventItemTemplate)(tripEvents[0]), _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
